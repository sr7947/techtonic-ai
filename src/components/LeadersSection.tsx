          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-10">
              ...
              <div className="lg:col-span-8 space-y-6">
                ...
                {activeLeader.id === 'microsoft' && (
                  <div className="pt-4 flex justify-center md:justify-start">
                    <button
                      onClick={() => {
                        window.history.pushState({}, '', '/leaders/microsoft-azure-ai');
                        window.dispatchEvent(new Event('pushstate'));
                        window.scrollTo({ top: 0, behavior: 'smooth' });
                      }}
                      className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-brand-gold hover:bg-brand-gold-bright text-brand-navy-dark text-xs font-extrabold uppercase tracking-wider transition-all shadow-md shadow-brand-gold/15 cursor-pointer border border-brand-gold"
                    >
                      <Building className="w-4 h-4" />
                      Explore Microsoft Ecosystem Hub
                    </button>
                  </div>
                )}

                {activeLeader.id === 'nvidia' && (
                  <div className="pt-4 flex justify-center md:justify-start">
                    <button
                      onClick={() => {
                        window.history.pushState({}, '', '/leaders/nvidia-ai');
                        window.dispatchEvent(new Event('pushstate'));
                        window.scrollTo({ top: 0, behavior: 'smooth' });
                      }}
                      className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-brand-gold hover:bg-brand-gold-bright text-brand-navy-dark text-xs font-extrabold uppercase tracking-wider transition-all shadow-md shadow-brand-gold/15 cursor-pointer border border-brand-gold"
                ...
                {activeLeader.id === 'apple' && (
                  <div className="pt-4 flex justify-center md:justify-start">
                    <button
                      onClick={() => {
                        window.history.pushState({}, '', '/leaders/apple-intelligence');
                        window.dispatchEvent(new Event('pushstate'));
                        window.scrollTo({ top: 0, behavior: 'smooth' });
                      }}
                      className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-brand-gold hover:bg-brand-gold-bright text-brand-navy-dark text-xs font-extrabold uppercase tracking-wider transition-all shadow-md shadow-brand-gold/15 cursor-pointer border border-brand-gold"
                ...
                {activeLeader.id === 'xai' && (
                  <div className="pt-4 flex justify-center md:justify-start">
                    <button
                      onClick={() => {
                        window.history.pushState({}, '', '/leaders/xai-grok');
                        window.dispatchEvent(new Event('pushstate'));
                        window.scrollTo({ top: 0, behavior: 'smooth' });
                      }}
                      className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-brand-gold hover:bg-brand-gold-bright text-brand-navy-dark text-xs font-extrabold uppercase tracking-wider transition-all shadow-md shadow-brand-gold/15 cursor-pointer border border-brand-gold"
                    >
                      <Building className="w-4 h-4" />
                      Explore xAI / Grok Ecosystem Hub
                    </button>
                  </div>
                )}

                {activeLeader.id === 'mistral' && (
                  <div className="pt-4 flex justify-center md:justify-start">
                    <button
                      onClick={() => {
                        window.history.pushState({}, '', '/leaders/mistral-ai');
                        window.dispatchEvent(new Event('pushstate'));
                        window.scrollTo({ top: 0, behavior: 'smooth' });
                      }}
                      className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-brand-gold hover:bg-brand-gold-bright text-brand-navy-dark text-xs font-extrabold uppercase tracking-wider transition-all shadow-md shadow-brand-gold/15 cursor-pointer border border-brand-gold"
                    >
                      <Building className="w-4 h-4" />
                      Explore Mistral AI Ecosystem Hub
                    </button>
                  </div>
                )}
                ...
                {activeLeader.id === 'ibm' && (
                  <div className="pt-4 flex justify-center md:justify-start">
                    <button
                      onClick={() => {
                        window.history.pushState({}, '', '/leaders/ibm-watsonx');
                        window.dispatchEvent(new Event('pushstate'));
                        window.scrollTo({ top: 0, behavior: 'smooth' });
                      }}
                      className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-brand-gold hover:bg-brand-gold-bright text-brand-navy-dark text-xs font-extrabold uppercase tracking-wider transition-all shadow-md shadow-brand-gold/15 cursor-pointer border border-brand-gold"
                    >
                      <Building className="w-4 h-4" />
                      Explore IBM / watsonx Ecosystem Hub
                    </button>
                  </div>
                )}

                {activeLeader.id === 'cohere' && (
                  <div className="pt-4 flex justify-center md:justify-start">
                    <button
                      onClick={() => {
                        window.history.pushState({}, '', '/leaders/cohere');
                        window.dispatchEvent(new Event('pushstate'));
                        window.scrollTo({ top: 0, behavior: 'smooth' });
                      }}
                      className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-brand-gold hover:bg-brand-gold-bright text-brand-navy-dark text-xs font-extrabold uppercase tracking-wider transition-all shadow-md shadow-brand-gold/15 cursor-pointer border border-brand-gold"
                    >
                      <Building className="w-4 h-4" />
                      Explore Cohere Ecosystem Hub
                    </button>
                  </div>
                )}

                {activeLeader.id === 'huggingface' && (
                  <div className="pt-4 flex justify-center md:justify-start">
                    <button
                      onClick={() => {
                        window.history.pushState({}, '', '/leaders/huggingface');
                        window.dispatchEvent(new Event('pushstate'));
                        window.scrollTo({ top: 0, behavior: 'smooth' });
                      }}
                      className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-brand-gold hover:bg-brand-gold-bright text-brand-navy-dark text-xs font-extrabold uppercase tracking-wider transition-all shadow-md shadow-brand-gold/15 cursor-pointer border border-brand-gold"
