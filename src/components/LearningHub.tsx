...
import { GithubReposDirectory } from './GithubReposDirectory';
...
export const LearningHub: React.FC<LearningHubProps> = ({ resources = LEARNING_RESOURCES }) => {
  const [activeMainTab, setActiveMainTab] = useState<'ecosystem' | 'github'>('ecosystem');
  ...
  return (
    <section id="learning" className="relative py-24 z-10 border-t border-brand-gold/5 bg-brand-navy-dark">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center border-b border-brand-gold/10 pb-6 mb-12 select-none">
          <div className="flex bg-brand-navy-deep/80 p-1.5 rounded-2xl border border-brand-gold/15 shadow-inner">
            <button
              onClick={() => setActiveMainTab('ecosystem')}
